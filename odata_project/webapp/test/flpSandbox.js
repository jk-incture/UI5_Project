		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData App",
									"targetURL": "#cominctureodataproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominctureodataproject-display": {
								"semanticObject": "cominctureodataproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incture.odataproject",
									"url": sap.ui.require.toUrl("com/incture/odataproject")
								}
							}
						}
					}
