		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comincturemydemoproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comincturemydemoproject1-display": {
								"semanticObject": "comincturemydemoproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incture.mydemoproject1",
									"url": sap.ui.require.toUrl("com/incture/mydemoproject1")
								}
							}
						}
					}
